...
function LoginForm({ onLogin }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        showOscar(`اسم من اسکاره و بهت خوش آمد میگم`);
        onLogin?.(data);
      } else {
        alert(data);
      }
  ...
  const handleResend = async () => {
    ...
    showOscar("کد رو برای بار چندم فرستادم");
    setTimer(30);
  };
    ...
    <div className="new-auth">
      ...
      <div className="login-section">
        <div className="login-btn-list">
          {loginType !== "google" && (
            <div className="login-btn" onClick={(e) => setLoginType("google")}>
              <div>
          ...
          {loginType !== "code" && (
            <div className="login-btn" onClick={(e) => setLoginType("code")}>
              <div>
          ...
          {loginType !== "passKey" && (
            <div className="login-btn" onClick={(e) => setLoginType("passKey")}>
              <div>
