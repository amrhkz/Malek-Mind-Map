...
import TimerTab from "../sigma-tab/timer-tab";
import TransactionTab from "../transaction-tab/transaction-tab";
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "sigma":
        return (
          <>
            <div className="dash-title">Sigma List</div>
            <TimerTab />
          </>
        );
      case "transaction":
        ...
        <div className="dashboard-card">
          <div className="dashboard-nav">
            <div className="dash-nav-group">
              ...
              <div
                className={`dash-nav-item ${
                  activeSection === "sigma" ? "active" : ""
                }`}
                onClick={() => setActiveSection("sigma")}
              >
                <i className="bx  bx-link bx-xs"></i>
                Sigma Timer
              </div>
            ...
            <div className="dash-nav-group">
              ...
              >
                <i className="bx bx-arrow-left-right bx-xs"></i>
                Transactions
              </div>
